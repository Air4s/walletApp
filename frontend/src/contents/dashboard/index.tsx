...
const Dashboard = () => {
  const headingContainerClass =
    "bg-white h-32 border border-[1px] border-[#0A1D56] rounded-2xl shadow-lg";
  const headingTitleClass =
    "mt-3 ml-3 text-xl text-[#0A1D56] font-bold tracking-wider";
  const iconContainerClass =
    "h-8 w-8 hover:bg-gray-300 hover:opacity-50 rounded-lg";
  ...
  const iconItems: IconInfo[] = [
    ...
    {
      icon: <BsGraphUpArrow className="h-4/5 w-4/5 mt-1.5" />,
      tooltipText: "Stock Market",
    },
  ];
